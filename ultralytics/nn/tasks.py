...
from ultralytics.nn.modules import (AIFI, C1, C2, C3, C3TR, SPP, SPPF, Bottleneck, BottleneckCSP, C2f, C3Ghost, C3x,
                                    ...
                                    RTDETRDecoder, Segment, CoordAtt, EfficientAttention,
                                    GAM_Attention,GCT,ShuffleAttention,ResBlock_CBAM,ECAAttention,MHSA,GlobalContext,
                                    GatherExcite, SwinTransformer, CSPStage, ContextGuidedBlock_Down, CARAFE, SimAM, BiLevelRoutingAttention, 
...
def parse_model(d, ch, verbose=True):  # model_dict, input_channels(3)
    ...
    for i, (f, n, m, args) in enumerate(d['backbone'] + d['head']):  # from, number, module, args
        ...
        if m in (Classify, Conv, ConvTranspose, GhostConv, Bottleneck, GhostBottleneck, SPP, SPPF, DWConv, Focus,
                 ...
                 GAM_Attention,GCT,ResBlock_CBAM,GlobalContext,GatherExcite, SwinTransformer, CSPStage, CARAFE, CoordAtt,):
            c1, c2 = ch[f], args[0]
